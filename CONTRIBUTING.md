...
posted to #fury-dev on irc.freenode.net).
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to Fury code or Fury's dependency code or Fury's potential/future dependency code or research which successfully implements Fury.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Fury Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Fury Maintainer Team.
