...
#define FURY_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
#include "common/fury_integration_test_hooks.h"

// NOTE(fury): This file only exists because I need a way to hook into the
...
// fury_integration_test_hooks.h functions which isn't possible to expose in
